        ...
        try {
            ...
            TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
                ...
                public void afterCommit() {
                    ...
                    try {
                    String recipient = Objects.requireNonNull(
                        Objects.requireNonNull(
                            Objects.requireNonNull(source.getCustomer(), "Source account customer is required")
                                .getUser(),
                            "Source account user is required"
                        ).getEmail(),
                        "Source account email is required"
                    );
                    notificationService.publishNotification(recipient, "Transfer Alert",
